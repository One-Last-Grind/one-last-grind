...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "MyCustomPhysicsLibrary", Meta = (DefaultToSelf = Object, DisplayName = "Get Level Name", Keywords = "MyCustomPhysicsLibrary"))
